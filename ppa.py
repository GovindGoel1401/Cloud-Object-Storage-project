...
# === IBM COS Configuration (from your creds + selected endpoint) ===
cos = boto3.client("s3",
    aws_access_key_id="c7aff42e1b19448896bbb36d3ef9f8b6",
    aws_secret_access_key="96eaf034cba0541a24d339341684a3f98c071e40d26eae5d",
    endpoint_url="https://s3.che01.cloud-object-storage.appdomain.cloud"  # You can swap this if needed
)

BUCKET_NAME = "moneyball-donotdelete-pr-9e4kq1taridiz8"  # Confirm this is correct



genai.configure(api_key="AIzaSyCtVgFcCm7G2WUHWy0RpXGGfFIuSEiyhm0")  
